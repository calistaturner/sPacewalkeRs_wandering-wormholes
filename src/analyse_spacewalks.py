...
def convert_stringhours_to_decimal(d):
...
df['duration_hrs'] = df['duration'].apply(convert_stringhours_to_decimal)
...
df_dur = df.copy()
df_dur['duration_hrs'] = df_dur['duration'].apply(convert_stringhours_to_decimal)
...
df_dist = df.copy()
df_dist['duration_hrs'] = df_dist['duration'].apply(convert_stringhours_to_decimal)
...
df_crew = df.copy()
df_crew['duration_hrs'] = df_crew['duration'].apply(convert_stringhours_to_decimal)
